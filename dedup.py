...
def main():
    ...
    parser_finalize.add_argument("-r", "--remove", action="store_true", help="Remove empty directories after move/delete")
    ...
    if args.command == "generate":
        ...
        handle_finalize(args.dup_file, args.move, args.remove, args.preserve_dir)

def handle_finalize(dup_file="dedup.txt", move=None, remove=False, preserve_dir=False):
