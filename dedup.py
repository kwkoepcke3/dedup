...
def main():
    ...
    parser_finalize.add_argument("-r", "--remove", action="store_true", help="Remove empty directories after move")
    ...
    if args.command == "generate":
        ...
        handle_finalize(args.dup_file, args.move, args.remove)

def handle_finalize(dup_file="dedup.txt", move=None, remove=False):
